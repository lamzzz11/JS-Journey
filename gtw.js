const datas = [
  { name: "lam", stack: "c#", age: 19 },
  { name: "risa", stack: "py", age: 16 },
  { name: "amanda", stack: "react", age: 24 },
  { name: "keyn", stack: "js", age: 21 },
];
...
datas
  ...
  .filter((x) => x.age > 20)
  .map((values) => console.log(values)); // ini kalo digabung.
